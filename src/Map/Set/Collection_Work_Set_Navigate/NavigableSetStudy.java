...
public class NavigableSetStudy {
    ...
    /*
      //    SortedSet<Integer> intSortedSet=new TreeSet<>();
        ...
        System.out.println("intersorted " +intSortedSet);  //[2, 10, 20, 35, 40, 50]

        //lower()
        System.out.println(intSortedSet.lower(39));  //35

        //higher()

        System.out.println(intSortedSet.higher(35)); //40

        //floor()  en yakın alt degeri veriyor
        System.out.println(intSortedSet.floor(41));  //40

        //ceiling()  en yakın ust degeri veriyor
        System.out.println(intSortedSet.ceiling(36));  //40

        //pollfirst

        System.out.println(intSortedSet.first());  //2
        System.out.println(intSortedSet); // [2,10, 20, 35, 40, 50]
        System.out.println(intSortedSet.pollFirst());
        System.out.println(intSortedSet);  // 2 yi donduruyor sonra 2 yi cıkartıyor [10, 20, 35, 40, 50]

        //polllast
        System.out.println(intSortedSet.pollLast()); //50
        System.out.println(intSortedSet); // 50 yi atıyor   [10, 20, 35, 40]

        //descending set   tersten yazıyor
        intSortedSet.addAll(Arrays.asList(30,60,70,80));
        System.out.println(" descending " +intSortedSet);
        ...
        //headset
        System.out.println(intSortedSet.headSet(30,true));

        //tailset()
        System.out.println(intSortedSet.tailSet(30,false));
